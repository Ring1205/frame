...
import com.jzxfyun.manager.event.PhoneEvent;
...
//            }
    ...
    private void initMediaPlayer() {
        ...
        try {
            Uri setDataSourceUri = Uri.parse("android.resource://com.zxycloud.zxwl/" + (stateCode == CommonUtils.STATE_CODE_FIRE ? R.raw.fire_alarm : R.raw.prefire_alarm));
