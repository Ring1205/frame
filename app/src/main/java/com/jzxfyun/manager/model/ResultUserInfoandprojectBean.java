...
public class ResultUserInfoandprojectBean extends BaseBean {
    /**
    ...
    private UserInfoandprojectBean data;

    public UserInfoandprojectBean getData() {
        return data;
    }

    public void setData(UserInfoandprojectBean data) {
        this.data = data;
    }
