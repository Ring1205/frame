...
import com.jzxfyun.common.utils.ScreenUtil;
...
public class ScrollPickerView extends RecyclerView {
    ...
    private int mItemSelectedOffset = -1;
    ...
    public void doDraw(Canvas canvas) {
        if (mItemHeight > 0) {
            ...
            int startX = screenX / 2 - mItemWidth / 2 - ScreenUtil.dp2px(getContext(),5);
            int stopX = mItemWidth + startX + ScreenUtil.dp2px(getContext(), 5);
    ...
    public void onDraw(Canvas c) {
        ...
        if (!mFirstAmend) {
            mFirstAmend = true;
            ((LinearLayoutManager) getLayoutManager()).scrollToPositionWithOffset(mItemSelectedOffset != -1 ? mItemSelectedOffset: getItemSelectedOffset(), 0);
        }
    }

    public void setScrollToPositionWithOffset(int position){
        mItemSelectedOffset = position;
    ...
    private void initPaint() {
        if (mBgPaint == null) {
            ...
            mBgPaint.setStrokeWidth(ScreenUtil.dp2px(getContext(), 1));
        }
    }
