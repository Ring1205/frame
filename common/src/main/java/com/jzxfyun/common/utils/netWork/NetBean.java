...
//            host = devHost;
     ...
     * 注册
     */
    public static final String actionSignUp = "clientSignUp";
    /**
     * 注销账号
     */
     ...
     * 添加单位
     */
    public static final String actionPostProjectAdd = "project/addUnicomProject";
    /**
     * 编辑单位
     */
    public static final String actionPostProjectEdit= "project/editUnicomProject";
    /**
     * 删除场所
     */
     ...
     * 火警复核
     */
    public static final String actionAlertReview = "FireAlertMonitor/fireAlertProcess";
    /**
     * 设置激光推送Id
     */
